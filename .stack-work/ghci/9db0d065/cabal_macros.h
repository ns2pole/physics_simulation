...
/* package uniform-motion-0.1.0.0 */
#ifndef VERSION_uniform_motion
#define VERSION_uniform_motion "0.1.0.0"
#endif /* VERSION_uniform_motion */
#ifndef MIN_VERSION_uniform_motion
#define MIN_VERSION_uniform_motion(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_uniform_motion */
...
#define CURRENT_COMPONENT_ID "uniform-motion-0.1.0.0-3uek1cEEL64FUTBWrUJz9X-uniform-motion"
